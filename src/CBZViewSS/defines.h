...
#define KEY_LEFT DINGOO_BUTTON_LEFT
#define KEY_RIGHT DINGOO_BUTTON_RIGHT
#define KEY_PGDOWN DINGOO_BUTTON_A
#define KEY_PGUP DINGOO_BUTTON_B
#define KEY_ZOOM DINGOO_BUTTON_Y
#define KEY_UNZOOM DINGOO_BUTTON_X
#define KEY_FOREXIT1 DINGOO_BUTTON_START
#define KEY_FOREXIT2 DINGOO_BUTTON_SELECT
#define KEY_LF DINGOO_BUTTON_R
#define KEY_FINESCROLL DINGOO_BUTTON_L
#endif
